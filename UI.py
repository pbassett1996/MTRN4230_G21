...
#start button
startButton = Button(root, text="START", command=start, width=10, height=2, fg="white", bg="green4",borderwidth=5)
startButton.place(x=50,y=100)
#stop button
stopButton = Button(root, text="STOP", command=start, width=10,height=2, fg="white", bg="red3",borderwidth=5)
...
#slider
quantity = Scale(root, from_=0, to=10, length=250, tickinterval=1, orient=HORIZONTAL, width=20)
